...
CUDA_VISIBLE_DEVICES=6 python CEEC/CEEC_only-infer-inpaint_save.py --cluster "0"
CUDA_VISIBLE_DEVICES=3 python CEEC/CEEC_only-infer-inpaint_save.py --cluster "all"
"""
