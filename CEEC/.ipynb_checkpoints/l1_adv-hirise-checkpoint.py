...
#olimar
CUDA_VISIBLE_DEVICES=2 python CEEC/l1_adv-hirise.py --dataset mars_hirise --cluster "4" --l1_adv
CUDA_VISIBLE_DEVICES=3 python CEEC/l1_adv-hirise.py --dataset mars_hirise --cluster "0" --l1_adv

#lucina
CUDA_VISIBLE_DEVICES=0 python CEEC/l1_adv-hirise.py --dataset mars_hirise --cluster "2" --l1_adv
CUDA_VISIBLE_DEVICES=6 python CEEC/l1_adv-hirise.py --dataset mars_hirise --cluster "all" --l1_adv --n_epochs 20
CUDA_VISIBLE_DEVICES=8 python CEEC/l1_adv-hirise.py --dataset mars_hirise --cluster "1" --l1_adv
CUDA_VISIBLE_DEVICES=9 python CEEC/l1_adv-hirise.py --dataset mars_hirise --cluster "3" --l1_adv
"""
